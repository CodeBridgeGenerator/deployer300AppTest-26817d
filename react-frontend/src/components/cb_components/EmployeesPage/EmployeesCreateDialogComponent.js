      ...
      >
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <Calendar
              id="dateJoined"
              value={_entity?.dateJoined ? new Date(_entity?.dateJoined) : null}
              dateFormat="dd/mm/yy"
              onChange={(e) => setValByKey("dateJoined", new Date(e.value))}
              showIcon
              showButtonBar
            />
          </span>
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <Calendar
              ...
              dateFormat="dd/mm/yy"
              onChange={(e) => setValByKey("dateTerminated", new Date(e.value))}
              showIcon
              showButtonBar
            />
          </span>
