  ...
  const onSave = async () => {
    ...
    try {
      ...
      props.alert({
        type: "success",
        title: "Create info",
        message: "Info Servicerecords created successfully",
      });
      ...
      props.alert({
        type: "error",
        title: "Create",
        message: "Failed to create in Servicerecords",
      });
    }
    setLoading(false);
  };
  ...
  return (
    ...
    >
      <div
        ...
        style={{ maxWidth: "55vw" }}
        role="servicerecords-create-dialog-component"
      >
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputNumber
              ...
              onChange={(e) => setValByKey("invoiceId", e.value)}
            />
          </span>
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputNumber
              id="serviceId"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.serviceId}
              onChange={(e) => setValByKey("serviceId", e.value)}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputNumber
              id="serviceDate"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.serviceDate}
              onChange={(e) => setValByKey("serviceDate", e.value)}
            />
          </span>
          <small className="p-error">
...
export default connect(
  mapState,
  mapDispatch,
)(ServicerecordsCreateDialogComponent);
