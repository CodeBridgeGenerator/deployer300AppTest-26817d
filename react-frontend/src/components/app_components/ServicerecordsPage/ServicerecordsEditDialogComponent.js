...
const ServicerecordsEditDialogComponent = (props) => {
  ...
  const onSave = async () => {
    ...
    try {
      ...
      props.alert({
        type: "success",
        title: "Edit info",
        message: "Info servicerecords updated successfully",
      });
  ...
  return (
    ...
    >
      <div
        ...
        style={{ maxWidth: "55vw" }}
        role="servicerecords-edit-dialog-component"
      >
...
export default connect(
  mapState,
  mapDispatch,
)(ServicerecordsEditDialogComponent);
