...
const SingleServicerecordsPage = (props) => {
  ...
  useEffect(() => {
    ...
    client
      ...
      .get(urlParams.singleServicerecordsId, {
        query: {
          $populate: [
            {
              path: "createdBy",
      ...
      .catch((error) => {
        ...
        props.alert({
          ...
          type: "error",
          message: error.message || "Failed get servicerecords",
        });
      });
          ...
          <div className="card w-full">
            <div className="grid ">
              <div className="col-12 md:col-6 lg:col-3">
                <label className="text-sm text-gray-600">InvoiceID</label>
                <p className="m-0 ml-3">{Number(_entity?.invoiceId)}</p>
              </div>
              <div className="col-12 md:col-6 lg:col-3">
                <label className="text-sm text-gray-600">ServiceID</label>
                <p className="m-0 ml-3">{Number(_entity?.serviceId)}</p>
              </div>
              <div className="col-12 md:col-6 lg:col-3">
              ...
              <div className="col-12 md:col-6 lg:col-3">
                <label className="text-sm text-gray-600">ServiceDate</label>
                <p className="m-0 ml-3">{Number(_entity?.serviceDate)}</p>
              </div>
