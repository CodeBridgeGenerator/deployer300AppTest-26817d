    ...
    <>
      ...
      >
        ...
        <Column
          ...
          header="SupplierName"
          body={pTemplate0}
          filter={selectedFilterFields.includes("supplierName")}
          hidden={selectedHideFields?.includes("supplierName")}
          sortable
          style={{ minWidth: "8rem" }}
        />
        <Column
          ...
          body={pTemplate1}
          filter={selectedFilterFields.includes("contactPerson")}
          hidden={selectedHideFields?.includes("contactPerson")}
          sortable
          style={{ minWidth: "8rem" }}
        />
        <Column
