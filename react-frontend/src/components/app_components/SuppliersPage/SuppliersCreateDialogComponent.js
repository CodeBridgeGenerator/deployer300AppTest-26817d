  ...
  const onSave = async () => {
    ...
    try {
      ...
      props.alert({
        type: "success",
        title: "Create info",
        message: "Info Suppliers created successfully",
      });
      ...
      props.alert({
        type: "error",
        title: "Create",
        message: "Failed to create in Suppliers",
      });
    }
    setLoading(false);
  };
  ...
  return (
    ...
    >
      <div
        ...
        style={{ maxWidth: "55vw" }}
        role="suppliers-create-dialog-component"
      >
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              ...
              value={_entity?.supplierName}
              onChange={(e) => setValByKey("supplierName", e.target.value)}
            />
          </span>
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              id="contactPerson"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.contactPerson}
              onChange={(e) => setValByKey("contactPerson", e.target.value)}
            />
          </span>
          <small className="p-error">
