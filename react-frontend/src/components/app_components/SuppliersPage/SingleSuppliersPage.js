...
const SingleSuppliersPage = (props) => {
  ...
  useEffect(() => {
    ...
    client
      .service("suppliers")
      .get(urlParams.singleSuppliersId, {
        query: {
          $populate: [
            {
              path: "createdBy",
      ...
      .catch((error) => {
        ...
        props.alert({
          title: "Suppliers",
          type: "error",
          message: error.message || "Failed get suppliers",
        });
      });
          ...
          <div className="card w-full">
            <div className="grid ">
              <div className="col-12 md:col-6 lg:col-3">
                <label className="text-sm text-gray-600">SupplierName</label>
                <p className="m-0 ml-3">{_entity?.supplierName}</p>
              </div>
              <div className="col-12 md:col-6 lg:col-3">
                <label className="text-sm text-gray-600">ContactPerson</label>
                <p className="m-0 ml-3">{_entity?.contactPerson}</p>
              </div>
              <div className="col-12 md:col-6 lg:col-3">
                <label className="text-sm text-gray-600">PhoneNumber</label>
