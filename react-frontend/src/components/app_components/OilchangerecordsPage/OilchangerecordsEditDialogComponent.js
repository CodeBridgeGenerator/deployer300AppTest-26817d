...
const OilchangerecordsEditDialogComponent = (props) => {
  ...
  const onSave = async () => {
    ...
    try {
      ...
      props.alert({
        type: "success",
        title: "Edit info",
        message: "Info oilchangerecords updated successfully",
      });
  ...
  return (
    ...
    >
      <div
        ...
        style={{ maxWidth: "55vw" }}
        role="oilchangerecords-edit-dialog-component"
      >
...
export default connect(
  mapState,
  mapDispatch,
)(OilchangerecordsEditDialogComponent);
