...
const OilchangerecordsCreateDialogComponent = (props) => {
  ...
  const onSave = async () => {
    ...
    try {
      ...
      props.alert({
        type: "success",
        title: "Create info",
        message: "Info Oilchangerecords created successfully",
      });
      ...
      props.alert({
        type: "error",
        title: "Create",
        message: "Failed to create in Oilchangerecords",
      });
    }
    setLoading(false);
  };
  ...
  return (
    <Dialog
      header="Create Oilchangerecords"
      visible={props.show}
      closable={false}
      onHide={props.onHide}
      modal
    ...
    >
      <div
        ...
        style={{ maxWidth: "55vw" }}
        role="oilchangerecords-create-dialog-component"
      >
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputNumber
              ...
              value={_entity?.vehicleId}
              onChange={(e) => setValByKey("vehicleId", e.value)}
            />
          </span>
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputNumber
              id="serviceRecordId"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.serviceRecordId}
              onChange={(e) => setValByKey("serviceRecordId", e.value)}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              id="oilType"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.oilType}
              onChange={(e) => setValByKey("oilType", e.target.value)}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputNumber
              id="mileage"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.mileage}
              onChange={(e) => setValByKey("mileage", e.value)}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputNumber
              ...
              onChange={(e) => setValByKey("technicianId", e.value)}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputNumber
              id="dateOfChange"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.dateOfChange}
              onChange={(e) => setValByKey("dateOfChange", e.value)}
            />
          </span>
          <small className="p-error">
...
export default connect(
  mapState,
  mapDispatch,
)(OilchangerecordsCreateDialogComponent);
