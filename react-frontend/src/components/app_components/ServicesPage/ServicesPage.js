    ...
    client
      ...
      .catch((error) => {
        ...
        props.alert({
          title: "Services",
          type: "error",
          message: error.message || "Failed get Services",
        });
      });
