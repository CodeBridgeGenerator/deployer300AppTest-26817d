...
const TechniciansPage = (props) => {
    ...
    client
      ...
      .catch((error) => {
        ...
        props.alert({
          title: "Technicians",
          type: "error",
          message: error.message || "Failed get Technicians",
        });
      });
  ...
  const deleteAll = async () => {
    ...
    const promises = data.map((e) =>
      client.service("technicians").remove(e._id),
    );
    await Promise.all(
      promises.map((p) =>
        p.catch((error) => {
