...
const TechniciansEditDialogComponent = (props) => {
  ...
  const onSave = async () => {
    ...
    try {
      ...
      props.alert({
        type: "success",
        title: "Edit info",
        message: "Info technicians updated successfully",
      });
  ...
  return (
    ...
    >
      <div
        ...
        style={{ maxWidth: "55vw" }}
        role="technicians-edit-dialog-component"
      >
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              id="specialization"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.specialization}
              onChange={(e) => setValByKey("specialization", e.target.value)}
            />
          </span>
          <small className="p-error">
...
export default connect(mapState, mapDispatch)(TechniciansEditDialogComponent);
