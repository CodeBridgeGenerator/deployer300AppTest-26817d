  ...
  const onSave = async () => {
    ...
    try {
      ...
      props.alert({
        type: "success",
        title: "Create info",
        message: "Info Vehicles created successfully",
      });
      ...
      props.alert({
        type: "error",
        title: "Create",
        message: "Failed to create in Vehicles",
      });
    }
    setLoading(false);
  };
  ...
  return (
    ...
    >
      <div
        ...
        style={{ maxWidth: "55vw" }}
        role="vehicles-create-dialog-component"
      >
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputNumber
              ...
              value={_entity?.customerId}
              onChange={(e) => setValByKey("customerId", e.value)}
            />
          </span>
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              ...
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.make}
              onChange={(e) => setValByKey("make", e.target.value)}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputNumber
              ...
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.year}
              onChange={(e) => setValByKey("year", e.value)}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              id="licensePlate"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.licensePlate}
              onChange={(e) => setValByKey("licensePlate", e.target.value)}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              ...
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.vin}
              onChange={(e) => setValByKey("vin", e.target.value)}
            />
          </span>
          <small className="p-error">
            {!_.isEmpty(error["vin"]) ? (
