...
const SingleVehiclesPage = (props) => {
  ...
  useEffect(() => {
    ...
    client
      .service("vehicles")
      .get(urlParams.singleVehiclesId, {
        query: {
          $populate: [
            {
              path: "createdBy",
      ...
      .catch((error) => {
        ...
        props.alert({
          title: "Vehicles",
          type: "error",
          message: error.message || "Failed get vehicles",
        });
      });
          ...
          <div className="card w-full">
            <div className="grid ">
              ...
              <div className="col-12 md:col-6 lg:col-3">
                ...
                <p className="m-0 ml-3">{_entity?.make}</p>
              </div>
              <div className="col-12 md:col-6 lg:col-3">
              ...
              <div className="col-12 md:col-6 lg:col-3">
                ...
                <p className="m-0 ml-3">{Number(_entity?.year)}</p>
              </div>
              <div className="col-12 md:col-6 lg:col-3">
                <label className="text-sm text-gray-600">LicensePlate</label>
                <p className="m-0 ml-3">{_entity?.licensePlate}</p>
              </div>
              <div className="col-12 md:col-6 lg:col-3">
                <label className="text-sm text-gray-600">VIN</label>
                <p className="m-0 ml-3">{_entity?.vin}</p>
              </div>
