  ...
  const onSave = async () => {
    ...
    try {
      ...
      props.alert({
        type: "success",
        title: "Create info",
        message: "Info Customers created successfully",
      });
  ...
  return (
    ...
    >
      <div
        ...
        style={{ maxWidth: "55vw" }}
        role="customers-create-dialog-component"
      >
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputNumber
              id="joinDate"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.joinDate}
              onChange={(e) => setValByKey("joinDate", e.value)}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputNumber
              id="loyaltyPoints"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.loyaltyPoints}
              onChange={(e) => setValByKey("loyaltyPoints", e.value)}
            />
          </span>
          <small className="p-error">
