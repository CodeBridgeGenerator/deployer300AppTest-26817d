...
const SingleCustomersPage = (props) => {
  ...
  useEffect(() => {
    ...
    client
      .service("customers")
      .get(urlParams.singleCustomersId, {
        query: {
          $populate: [
            {
              path: "createdBy",
        ...
        <div className="col-12">
          ...
          <div className="card w-full">
            <div className="grid ">
              ...
              <div className="col-12 md:col-6 lg:col-3">
                <label className="text-sm text-gray-600">JoinDate</label>
                <p className="m-0 ml-3">{Number(_entity?.joinDate)}</p>
              </div>
              <div className="col-12 md:col-6 lg:col-3">
                <label className="text-sm text-gray-600">LoyaltyPoints</label>
                <p className="m-0 ml-3">{Number(_entity?.loyaltyPoints)}</p>
              </div>
