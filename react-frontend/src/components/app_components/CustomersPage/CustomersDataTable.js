...
const CustomersDataTable = ({
  ...
  const p_numberTemplate5 = (rowData, { rowIndex }) => (
    <p>{rowData.joinDate}</p>
  );
  const p_numberTemplate6 = (rowData, { rowIndex }) => (
    <p>{rowData.loyaltyPoints}</p>
  );
    ...
    <>
      ...
      >
        ...
        <Column
          ...
          filter={selectedFilterFields.includes("joinDate")}
          hidden={selectedHideFields?.includes("joinDate")}
          sortable
          style={{ minWidth: "8rem" }}
        />
        <Column
          ...
          filter={selectedFilterFields.includes("loyaltyPoints")}
          hidden={selectedHideFields?.includes("loyaltyPoints")}
          sortable
          style={{ minWidth: "8rem" }}
        />
