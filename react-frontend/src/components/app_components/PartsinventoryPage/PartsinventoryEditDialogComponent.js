...
const PartsinventoryEditDialogComponent = (props) => {
  ...
  const onSave = async () => {
    ...
    try {
      ...
      props.alert({
        type: "success",
        title: "Edit info",
        message: "Info partsinventory updated successfully",
      });
  ...
  return (
    ...
    >
      <div
        ...
        style={{ maxWidth: "55vw" }}
        role="partsinventory-edit-dialog-component"
      >
...
export default connect(
  mapState,
  mapDispatch,
)(PartsinventoryEditDialogComponent);
