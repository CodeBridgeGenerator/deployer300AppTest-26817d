...
const LoyaltyprogramsEditDialogComponent = (props) => {
  ...
  const onSave = async () => {
    ...
    try {
      ...
      props.alert({
        type: "success",
        title: "Edit info",
        message: "Info loyaltyprograms updated successfully",
      });
  ...
  return (
    ...
    >
      <div
        ...
        style={{ maxWidth: "55vw" }}
        role="loyaltyprograms-edit-dialog-component"
      >
...
export default connect(
  mapState,
  mapDispatch,
)(LoyaltyprogramsEditDialogComponent);
