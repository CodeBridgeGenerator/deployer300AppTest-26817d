  ...
  const onSave = async () => {
    ...
    try {
      ...
      props.alert({
        type: "success",
        title: "Create info",
        message: "Info Loyaltyprograms created successfully",
      });
      ...
      props.alert({
        type: "error",
        title: "Create",
        message: "Failed to create in Loyaltyprograms",
      });
    }
    setLoading(false);
  };
  ...
  return (
    ...
    >
      <div
        ...
        style={{ maxWidth: "55vw" }}
        role="loyaltyprograms-create-dialog-component"
      >
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputNumber
              ...
              value={_entity?.partId}
              onChange={(e) => setValByKey("partId", e.value)}
            />
          </span>
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              id="partName"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.partName}
              onChange={(e) => setValByKey("partName", e.target.value)}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputNumber
              id="quantityInStock"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.quantityInStock}
              onChange={(e) => setValByKey("quantityInStock", e.value)}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputNumber
              id="supplierId"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.supplierId}
              onChange={(e) => setValByKey("supplierId", e.value)}
            />
          </span>
          <small className="p-error">
...
export default connect(
  mapState,
  mapDispatch,
)(LoyaltyprogramsCreateDialogComponent);
