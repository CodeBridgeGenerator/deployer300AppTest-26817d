...
const SingleLoyaltyprogramsPage = (props) => {
  ...
  useEffect(() => {
    ...
    client
      ...
      .get(urlParams.singleLoyaltyprogramsId, {
        query: {
          $populate: [
            {
              path: "createdBy",
      ...
      .catch((error) => {
        ...
        props.alert({
          ...
          type: "error",
          message: error.message || "Failed get loyaltyprograms",
        });
      });
          ...
          <div className="card w-full">
            <div className="grid ">
              <div className="col-12 md:col-6 lg:col-3">
                <label className="text-sm text-gray-600">PartID</label>
                <p className="m-0 ml-3">{Number(_entity?.partId)}</p>
              </div>
              <div className="col-12 md:col-6 lg:col-3">
                <label className="text-sm text-gray-600">PartName</label>
                <p className="m-0 ml-3">{_entity?.partName}</p>
              </div>
              <div className="col-12 md:col-6 lg:col-3">
              ...
              <div className="col-12 md:col-6 lg:col-3">
                <label className="text-sm text-gray-600">QuantityInStock</label>
                <p className="m-0 ml-3">{Number(_entity?.quantityInStock)}</p>
              </div>
              <div className="col-12 md:col-6 lg:col-3">
              ...
              <div className="col-12 md:col-6 lg:col-3">
                ...
                <p className="m-0 ml-3">{Number(_entity?.supplierId)}</p>
              </div>
