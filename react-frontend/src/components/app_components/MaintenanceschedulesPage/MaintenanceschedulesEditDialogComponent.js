...
const MaintenanceschedulesEditDialogComponent = (props) => {
  ...
  const onSave = async () => {
    ...
    try {
      ...
      props.alert({
        type: "success",
        title: "Edit info",
        message: "Info maintenanceschedules updated successfully",
      });
  ...
  return (
    <Dialog
      header="Edit Maintenanceschedules"
      visible={props.show}
      closable={false}
      onHide={props.onHide}
      modal
    ...
    >
      <div
        ...
        style={{ maxWidth: "55vw" }}
        role="maintenanceschedules-edit-dialog-component"
      >
...
export default connect(
  mapState,
  mapDispatch,
)(MaintenanceschedulesEditDialogComponent);
