...
const MaintenanceschedulesCreateDialogComponent = (props) => {
  ...
  const onSave = async () => {
    ...
    try {
      ...
      props.alert({
        type: "success",
        title: "Create info",
        message: "Info Maintenanceschedules created successfully",
      });
      ...
      props.alert({
        type: "error",
        title: "Create",
        message: "Failed to create in Maintenanceschedules",
      });
    }
    setLoading(false);
  };
  ...
  return (
    <Dialog
      header="Create Maintenanceschedules"
      visible={props.show}
      closable={false}
      onHide={props.onHide}
      modal
    ...
    >
      <div
        ...
        style={{ maxWidth: "55vw" }}
        role="maintenanceschedules-create-dialog-component"
      >
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputNumber
              id="nextServiceDate"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.nextServiceDate}
              onChange={(e) => setValByKey("nextServiceDate", e.value)}
            />
          </span>
          <small className="p-error">
...
export default connect(
  mapState,
  mapDispatch,
)(MaintenanceschedulesCreateDialogComponent);
